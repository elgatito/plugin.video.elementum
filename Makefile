...
$(ZIP_FILE):
	...
	zip -9 -r -x .git -x ".git/*" -g $(ZIP_FILE) $(NAME)/resources/site-packages/platform_detect
...
deps:
	...
	rm -rf `pwd`/$(DEV)/resources/site-packages/platform_detect
	mkdir -p `pwd`/$(DEV)/resources/site-packages
